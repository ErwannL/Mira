...
| `FIGURA_READY_TIMEOUT_MS`                | worker      | `120000` (default)                                              | Browser runs wait this long for the web app and API to answer before the first step (`TARGET_NOT_READY` after).        |
