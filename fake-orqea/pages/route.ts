...
export const params = (req: FastifyRequest): Record<string, string> => req.params as Record<string, string>;
export const query = (req: FastifyRequest): Record<string, string | undefined> => req.query as Record<string, string | undefined>;

export function pageRoute(app: FastifyInstance, deps: Deps, path: string, render: PublicRender, needsUser: boolean): void {
...
export const publicPage = (app: FastifyInstance, deps: Deps, path: string, render: PublicRender): void =>
  pageRoute(app, deps, path, render, false);
